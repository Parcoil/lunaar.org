      ...
      b
        ...
        (_.prototype.bindEvt = function (t, i) {
          ...
          return (
            ...
            p(t, o[i], e._domHandlers_[i]),
            w[i] && p(t, w[i], e._domHandlers_[i]),
            e
          );
        }),
        ...
        (k.prototype.hide = function (t) {
          ...
          if (
            ...
            var e = i.options.restJoystick,
              o = {};
            (o.x = !0 === e || !1 !== e.x ? 0 : i.instance.frontPosition.x),
              (o.y = !0 === e || !1 !== e.y ? 0 : i.instance.frontPosition.y),
              i.setPosition(t, o);
          }
          return i;
        }),
      ...
      (E.prototype = new T()),
            ...
            (o.pressureIntervals[e] = setInterval(
              function () {
                ...
                e !== n &&
                  ...
                  o.trigger("pressure " + i.identifier + ":pressure", e),
                  (n = e));
              }.bind(o),
              100
            ));
        ...
        (E.prototype.processOnStart = function (t) {
          var i,
            ...
            a = e.getOrCreate(s, d);
          a.identifier !== s && e.manager.removeIdentifier(a.identifier),
            (a.identifier = s);
          var p = function (i) {
            i.trigger("start", i),
          ...
          if (
            ...
            if (!(n(d, a.position) <= o.catchDistance))
              return a.destroy(), void e.processOnStart(t);
            p(a);
          }
          return a;
        }),
          ...
          if (
            ...
            if (
              ...
              if (O > p) {
                ...
                (o.position.x += P),
                  (o.position.y += E),
                  (o.el.style.top = o.position.y - (this.box.top + d.y) + "px"),
                  (o.el.style.left =
        ...
        (E.prototype.processOnEnd = function (t) {
          ...
          n &&
            ...
            i.ids.indexOf(n.identifier) >= 0 &&
              i.ids.splice(i.ids.indexOf(n.identifier), 1),
            i.actives.indexOf(n) >= 0 &&
              i.actives.splice(i.actives.indexOf(n), 1),
            /(semi|static)/.test(e.mode)
              ? i.idles.push(n)
              : i.nipples.indexOf(n) >= 0 &&
                i.nipples.splice(i.nipples.indexOf(n), 1),
            i.manager.unbindDocument(),
            /(semi|static)/.test(e.mode) &&
              (i.manager.ids[s.id] = s.identifier));
        }),
      ...
      (z.prototype = new T()),
        ...
        (z.prototype.getIdentifier = function (t) {
          ...
          return (
            t
              ? void 0 ===
                  (i = void 0 === t.identifier ? t.pointerId : t.identifier) &&
                (i = this.latest || 0)
              : (i = this.index),
            void 0 === this.ids[i] &&
        ...
        (z.prototype.onAny = function (t, i) {
          ...
          return (
            v(i, function (t) {
              (e = o.getIdentifier(t)),
                v(o.collections, s.bind(null, t, e)),
