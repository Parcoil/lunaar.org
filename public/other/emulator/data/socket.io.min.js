...
!(function (t, e) {
              ...
              for (
                var n = function (n) {
                    ...
                    !(function (t, e) {
                      ...
                      })(r, t) && e.writer.write(Uint8Array.of(54)),
                        e.writer.write(t).then(function () {
                          i &&
                            at(function () {
                              (e.writable = !0), e.emitReserved("drain");
                            }, e.setTimeoutFn);
  ...
  function Ot(t) {
    var e = [],
      ...
      r = t;
    return (
      (r.data = At(n, e)), (r.attachments = e.length), { packet: r, buffers: e }
    );
  }
  function At(e, n) {
    if (!e) return e;
              ...
              return function () {
                if (!n) {
                  ...
                  for (
                    ...
                    i[o] = arguments[o];
                  e.packet({ type: Tt.ACK, id: t, data: i });
                }
              };
            },
          },
